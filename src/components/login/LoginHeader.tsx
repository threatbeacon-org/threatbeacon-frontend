...
export default function LoginHeader() {
  return (
    <div className="text-center w-full">
      ...
      >
        <Shield className="w-3 h-3 sm:w-4 sm:h-4 text-cyan-400 shrink-0" />
      ...
      <motion.h1
        ...
        className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-bold mb-2 sm:mb-3 font-cyber-title wrap-break-word"
        style={{
      ...
      >
        ...
        <span
          className="text-green-400 ml-1 sm:ml-2"
          style={{ textShadow: "0 0 20px rgba(0, 255, 138, 0.8)" }}
        >
          Beacon
        </span>
      </motion.h1>
